...
class _PausedRecordingState extends State<PausedRecording>
  ...
  Future<void> _addBookmark() async {
    ...
    final bookmarkTime =
        _isDraggingWaveform ? _draggedSeconds : _elapsedSeconds;
                ...
                return FutureBuilder<Map<String, String>>(
                  ...
                  builder: (context, userNamesSnapshot) {
                    ...
                    return ListView(
                      ...
                      children: [
                        // Top indicator: reduce top padding
                        Padding(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  TextButton(
                                    ...
                                    child: Text('Done', style: const TextStyle(color: Color.fromARGB(255, 47, 142, 238), fontSize: 15)),
                                  ),
                                ],
                              ),
                              const SizedBox(height: 4),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    _loadingCreator
                                            ...
                                            onTap: () async {
                                              ...
                                              if (result != null &&
                                                ...
                                                if (newName !=
                                                  ...
                                                  await _updateRecordingNameInFirestore(
                                                    newName,
                                                  );
                                                }
                                              }
                                        ...
                                        : Tooltip(
                                          message:
                                              'Only the creator can rename this recording',
                                          child: const Icon(
                                            Icons.edit_off,
                                            size: 18,
                                            color: Colors.grey,
                          ...
                          Column(
                            children: [
                              Container(
                                ...
                                child: CircleAvatar(
                                  radius:
                                      26, // Slightly smaller to ensure even border
                                  backgroundColor: Colors.grey[400],
                                  backgroundImage:
                                      _creatorProfilePictureUrl != null &&
                                              _creatorProfilePictureUrl!
                                                  .isNotEmpty
                                          ? NetworkImage(
                                            _creatorProfilePictureUrl!,
                                          )
                        ...
                        GestureDetector(
                          ...
                          onHorizontalDragUpdate: (details) async {
                            ...
                            if (totalDuration != null &&
                              ...
                              final newPosition = Duration(
                                milliseconds:
                                    (totalDuration.inMilliseconds * percent)
                                        .toInt(),
                              );
                              setState(() {
                                _waveformScrollFraction =
                                    percent.isNaN || percent.isInfinite
                                        ? 0.0
                                        : percent;
                                _draggedSeconds =
                                    newPosition.inMilliseconds / 1000.0;
                              });
                            }
                          },
                          onHorizontalDragEnd: (details) async {
                            ...
                            if (totalDuration != null &&
                                totalDuration.inMilliseconds > 0) {
                              final safeFraction =
                                  _waveformScrollFraction.isNaN ||
                                          _waveformScrollFraction.isInfinite
                                      ? 0.0
                                      : _waveformScrollFraction;
                              final newPosition = Duration(
                                milliseconds:
                                    (totalDuration.inMilliseconds * safeFraction)
                                        .toInt(),
                              );
                            ...
                            children: [
                                  ...
                                  child: ClipRect(
                                    child: CustomPaint(
                                      painter: _WaveformPainter(
                                        phase:
                                            _isPlaying ? _controller.value : 0.0,
                              ...
                              if (snapshot.hasData &&
                                ...
                                ...snapshot.data!.docs.map((doc) {
                                  ...
                                  final bookmarkTime =
                                      (data['bookmark_time'] ?? 0.0) as num;
                                  final userId = data['userId'] as String?;
                                  final userName =
                                      userId != null && userNames != null
                                          ? userNames[userId]
                                          : null;
                                  ...
                                  final x =
                                      totalDuration > 0
                                          ? (bookmarkTime / totalDuration) *
                                              waveformWidth
                                          : 0.0;
                                  return Positioned(
                                    left: x.clamp(0.0, waveformWidth - 1),
                                    top: -1,
                                    child: SizedBox(
                                      width: 24, // enough for icon and line
                                      height: 120, // waveform height
                                      child: Stack(
                              ...
                              Positioned(
                                ...
                                child: Center(
                                  child: Container(
                                    width: 2,
                                    height:
                                        120, // match the waveform container's height
                                    color: Colors.blue,
                                  ),
                                ),
                              ),
                        ...
                        const SizedBox(height: 16),
                        // Bookmarks list: use a dynamic max height
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 12.0),
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    if (_isAddingBookmark &&
                                        _pendingBookmarkTime != null &&
                                        index == filteredBookmarks.length) {
                                      final currentUser =
                                          FirebaseAuth.instance.currentUser;
                                      final currentUserName =
                                          userNames[currentUser?.uid] ?? '';
                                      final userColor = getUserColor(
                                        currentUser?.uid,
                                        currentUserName,
                                      );
            ...
            MediaQuery.of(context).viewInsets.bottom == 0
                ? SizedBox(
                  ...
                  child: FloatingActionButton(
                    onPressed:
                        _isAudioPlaying ? _onPausePressed : _onPlayPressed,
                    elevation: 0,
                    backgroundColor: Colors.white,
...
class _WaveformPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final safeScrollFraction =
        scrollFraction.isNaN || scrollFraction.isInfinite
            ? 0.0
            : scrollFraction;
